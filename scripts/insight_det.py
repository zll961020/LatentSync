...
INSIGHTFACE_DETECT_SIZE = 256

# download insightface automatically, set root='.' if you want to save it in current folder
app = FaceAnalysis(allowed_modules=['detection', 'landmark_2d_106']) 
app.prepare(ctx_id=0, det_size=(INSIGHTFACE_DETECT_SIZE, INSIGHTFACE_DETECT_SIZE))

def get_insight_face_one_frame(frame, threshold=0.5):
    f_h, f_w, _ = frame.shape
    lmk_adapt_origin_order = [1, 10, 12, 14, 16, 3, 5, 7, 0, 23, 21, 19, 32, 30, 28, 26, 17,
